...
export declare const Routes: {
    ...
    userNickname: (serverId: string, userId: string) => `/servers/${string}/users/${string}/nickname`;
    ...
    channelListItem: (channelId: string, listItemId: string) => `/channels/${string}/items/${string}`;
    channelDocs: (channelId: string) => `/channels/${string}/docs`;
    channelDoc: (channelId: string, docId: string) => `/channels/${string}/docs/${string}`;
    messageReaction: (channelId: string, contentId: string, emoteId: string) => `/channels/${string}/content/${string}/emotes/${string}`;
    ...
    memberSocialLink: (serverId: string, userId: string, type: string) => `/servers/${string}/members/${string}/social-links/${string}`;
    groupMember: (groupId: string, userId: string) => `/groups/${string}/members/${string}`;
    memberRole: (serverId: string, userId: string, roleId: string) => `/servers/${string}/members/${string}/roles/${string}`;
