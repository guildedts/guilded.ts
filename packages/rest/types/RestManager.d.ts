...
export declare class RestManager {
     ...
     */
    make<R = any, B = any, P extends Record<string, string> = Record<string, string>>(options: MakeOptions<B, P>, authenticated?: boolean): Promise<R>;
    /**
     ...
     * @throws {GuildedAPIError} if the request fails.
     */
    get<R = any, P extends Record<string, string> = Record<string, string>>(path: string, authenticated?: boolean, params?: P): Promise<R>;
    /**
