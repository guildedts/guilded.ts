...
export class MessageManager extends BaseManager<string, Message> {
	...
	public constructor(public readonly channel: ChatChannel) {
	 ...
	 */
	public fetch(message: string | Message, options?: FetchOptions): Promise<Message>;
	/**
	 ...
	 */
	public fetch(options?: FetchMessagesOptions): Promise<Collection<string, Message>>;
	/** @ignore */
	public async fetch(arg1?: string | Message | FetchMessagesOptions, arg2?: FetchOptions) {
	 ...
	 */
	public async edit(message: string | Message, payload: MessageEditPayloadResolvable) {
		message = message instanceof Message ? message.id : message;
	 ...
	 */
	public delete(message: string | Message) {
		message = message instanceof Message ? message.id : message;
